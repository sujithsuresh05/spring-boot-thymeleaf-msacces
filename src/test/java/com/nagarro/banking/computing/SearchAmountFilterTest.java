...
public class SearchAmountFilterTest {
    ...
    void filter_returnTrue() throws ParseException {
        ...
        StatementDto statementDto = StatementDto.of(1, "$2a$10$zwdV6sUKZ5/eD/OaCu.JbOysDYdBb3U0eQiPMqBbWCKHAXoUQnCCS", "123", date, Double.parseDouble("500"));
